...
data["Score1"] = data.groupby("Year")["median_roic_5y"].rank(pct=True)
data["Score2"] = data.groupby("Year")["gross_profitability"].rank(pct=True)
data["Score3"] = data.groupby("Year")["accrual_ratio_3y"].rank(pct=True, ascending=False)
data["Score4"] = data.groupby("Year")["revenue_cagr_3y"].rank(pct=True)
data["Score5"] = data.groupby("Year")["operating_margin_change_3y"].rank(pct=True)
data["Score6"] = data.groupby("Year")["net_debt_to_ebitda"].rank(pct=True, ascending=False)
data["Score7"] = data.groupby("Year")["ebit_yield"].rank(pct=True)
data["Score8"] = data.groupby("Year")["fcf_yield"].rank(pct=True)
data["Score9"] = data.groupby("Year")["volatility"].rank(pct=True, ascending=False)
...
print(data[["Ticker", "Year", "Ticker_Score", "Ticker_Rank", "Top_20"]].sort_values(["Year", "Ticker_Rank"]))
    #what is printed is not rlly important

#save to csv
winners = data[data["Top_20"]].sort_values(["Year", "Ticker_Rank"])
winners.to_csv("data/processed/winners.csv", index=False)
